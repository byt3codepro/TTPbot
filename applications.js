...
async function replydm(message) {
	...
	if (messagerefrence != undefined && messagerefrence.author.id === client.user.id && messagerefrence.embeds[1] != undefined) { //messagerefrence.embeds[1] != undefined
		console.log(messagerefrence) //message.channel.send(messagerefrence)
	} else {
