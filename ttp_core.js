...
client.on('message', message => {
    if (message.guild === null) {
        ...
        if (message.content == '/TTP') {
            message.channel.send("Dibināta 1944.gada oktobrī kā Rīgas pilsētas darbaļaužu deputātu padomes IK Rīgas pilsētas satiksmes un transporta pārvalde. No 19.01.1945.g. pārvalde tiek pārdēvēta par Rīgas pilsētas satiksmes un transporta trestu.No 01.01.1955.g. trests tiek pārdēvēts par Rīgas pilsētas tramvaju un trolejbusu trestu.No 30.12.1961.g. trests pārdēvēts par Tramvaju un trolejbusu pārvaldi.No 1991.g. Rīgas pilsētas pašvaldības uzņēmums 'Tramvaju un trolejbusu pārvalde'. Saskaņā ar RD lēmumu Nr.3171 'Par SIA 'Tramvaju un trolejbusu pārvalde'pvienošanu ar SIA 'Rīgas satiksme''un SIA 'Rīgas satiksme' dalībnieku 23.09.2004. kopsapulces lēmumu pievienota SIA 'Rīgas satiksme'.", {files: ['http://forum.myriga.info/index.php?act=attach&type=post&id=46210']});
        }
